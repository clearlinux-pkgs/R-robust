...
popd
pushd ..
cp -a robust buildavx512
popd
pushd ..
cp -a robust buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724079548
...
/V4/usr/lib64/R/library/robust/libs/robust.so
/VA/usr/lib64/R/library/robust/libs/robust.so
