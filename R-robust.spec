...
Version  : 0.6.0
Release  : 31
URL      : https://cran.r-project.org/src/contrib/robust_0.6-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/robust_0.6-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635178014
