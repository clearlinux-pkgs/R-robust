...
Version  : 0.4.18.2
Release  : 17
URL      : https://cran.r-project.org/src/contrib/robust_0.4-18.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/robust_0.4-18.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578159824
